...
Term str_obj(string &str)
{
  int len = str.length();
  term_v chars(len);
  for (int i=0 ; i < len ; i++)
    chars[i] = int_obj(str[i]);
  return tagged_obj(Symbol("string"), seq_obj(chars));
}
...
Term empty_seq_obj()
{
  return seq_obj(term_v());
}

Term empty_set_obj()
{
  return set_obj(term_v());
}

Term empty_map_obj()
{
  return map_obj(term_v(), term_v());
}
...
{
  return map_obj(
           mk_v(symbol_obj(lab1), symbol_obj(lab2)),
           mk_v(obj1, obj2)
         );
}
...
{
  return map_obj(
           mk_v(symbol_obj(lab1), symbol_obj(lab2), symbol_obj(lab3)),
           mk_v(obj1, obj2, obj3)
         );
}
...
{
  return map_obj(
           mk_v(symbol_obj(lab1), symbol_obj(lab2), symbol_obj(lab3), symbol_obj(lab4)),
           mk_v(obj1, obj2, obj3, obj4)
         );
}
...
{
  return map_obj(
           mk_v(symbol_obj(lab1), symbol_obj(lab2), symbol_obj(lab3), symbol_obj(lab4), symbol_obj(lab5)),
           mk_v(obj1, obj2, obj3, obj4, obj5)
         );
}

Term tagged_map(const char *tag, const char *lab, Term obj)
{
  return tagged_obj(tag, map_obj(lab, obj));
}

Term tagged_map(const char *tag, const char *lab1, Term obj1, const char *lab2, Term obj2)
{
  return tagged_obj(tag, map_obj(lab1, obj1, lab2, obj2));
}

Term tagged_map(const char *tag, const char *lab1, Term obj1, const char *lab2, Term obj2, const char *lab3, Term obj3)
{
  return tagged_obj(tag, map_obj(lab1, obj1, lab2, obj2, lab3, obj3));
}
...
{
  return tagged_obj(tag, map_obj(lab1, obj1, lab2, obj2, lab3, obj3, lab4, obj4));
}
...
{
  return tagged_obj(tag, map_obj(lab1, obj1, lab2, obj2, lab3, obj3, lab4, obj4, lab5, obj5));
}
