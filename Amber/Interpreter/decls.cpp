...
Typedef::Typedef(string &type_name, ::type &type) : type_name(type_name), type(type)
{
...
: type_name(type_name), params(params), type(type)
{
...
type ParTypedef::instantiate(type_v &actual_params)
{
  ...
  return type->clone_and_bind_params(params, actual_params);
