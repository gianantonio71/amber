...
{
public:
  FnArg()                       : type(new PseudoTypeAny)                 {}
  FnArg(PlainId var)            : type(new PseudoTypeAny), var(var)       {}
  FnArg(type type)              : type(type),              var(PlainId()) {}
  FnArg(type type, PlainId var) : type(type),              var(var)       {}
